...
public class PlatformSpawner : MonoBehaviour{
    ...
    public float timeBetSpawnMin = 1.25f; // 다음 배치까지의 시간간격 최솟값 
    public float timeBestSpawMax = 2.25f; // 다음배치까지의 시간 간격 최댓값
    private float timeBestSpawn; // 다음 배치까지의 시간 간격
    ...
    void Update()
    {
        ...
        if (Time.time >= lastSpawnTime + timeBestSpawn)
        {
            ...
            timeBestSpawn = Random.Range(yMin, yMax);
